...
const AImodels = () => {
    return (
        <div>
            <section className="bg-linear-to-r from-gray-100 to-blue-100 py-16 px-6 mt-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed">
                        ...
                        <span className="font-semibold text-blue-700"> Neural Network</span>,
                        which mimics how the human brain processes information. These models are
                        widely used in real-world applications such as
                        <span className="text-blue-700 font-medium"> chatbots</span> (like ChatGPT),
                        <span className="text-blue-700 font-medium"> image recognition</span>,
                        speech assistants, and
                        <span className="text-blue-700 font-medium"> recommendation systems</span>.
                        <br /><br />
