                    ...
                    <div className="flex flex-wrap gap-4 mt-8">
                        {
                            isCreator ? (
                                <>
                                    <button className="px-6 py-3 rounded-xl border-2 border-blue-500 text-blue-600 font-semibold hover:bg-blue-50 transition">Edit</button>
